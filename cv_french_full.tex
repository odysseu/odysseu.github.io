...
\resumeDetailedProject
    ...
    {2021-2024}
    {Bash, Python, YAML}
    {Docker, Helm, Pipelines GitLab, GitHub Actions, Grafana, Prometheus, Vault, Terraform}
...
\resumeDetailedProject
    ...
    {Co-\'edition du rapport officiel sur les statistiques annuelles de l'Irlande. D\'eveloppement de pipeline de g\'en\'eration de rapports automatis\'es et cr\'eation de mod\`eles réutilisables pour les rapports futurs.}
...
\begin{minipage}[t]{0.65\linewidth}
    ...
    \resumeSubItem{Bases de donn\'ees}{PostgreSQL, DuckDB, MySQL, MongoDB}
    \resumeSubItem{Plateformes Cloud}{Google Cloud Platform (GCP), Amazon Web Services (AWS)}
    \resumeSubItem{Ing\'enierie des donn\'ees}{Apache Airflow, Pandas, NumPy, Apache Spark}
    \resumeSubItem{ML/IA}{scikit-learn, TensorFlow, Transformers, HuggingFace, Fine-tuning de LLM}
    \resumeSubItem{Monitoring}{Prometheus, Grafana, Stack ELK, Datadog}
    \resumeSubItem{Outils DevOps}{Ansible, Vault, ArgoCD, Jenkins}
    \resumeSubHeadingListEnd
    \end{minipage}
\hfill
